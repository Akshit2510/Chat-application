    ...
    <body>
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                    ...
                    <div class="row">
                        <div class="col-md-12 right-chat-textbox">
                            <form method="post">
                                <input autocomplete="off" id="inpu" type="text" name="msg_content" placeholder="Type message...">
                                <button class="btn" id="btn" name="submit"><i class="fa fa-telegram" aria-hidden="true"></i></button> 
                            </form>
                        </div>
                    </div>
                </div>
        ...
        if(isset($_POST['submit']))
        {
            ...
            else if(strlen($msg)>100)
            {
                echo "
                    <div class='alert alert-danger'>
                    <strong><center>Message is to long use only 100 characters to send.</center></strong>
                    </div>
                ";
            }
            else
